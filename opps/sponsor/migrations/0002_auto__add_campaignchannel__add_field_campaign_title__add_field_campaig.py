...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'sponsor_campaign', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Campaign.visibility'
        db.add_column(u'sponsor_campaign', 'visibility',
                      self.gf('django.db.models.fields.CharField')(default='post', max_length=20),
                      keep_default=False)

        # Adding field 'Campaign.cssclass'
        db.add_column(u'sponsor_campaign', 'cssclass',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Campaign.style'
        db.add_column(u'sponsor_campaign', 'style',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Campaign.keyword'
        db.add_column(u'sponsor_campaign', 'keyword',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'sponsor_campaign', 'title')

        # Deleting field 'Campaign.visibility'
        db.delete_column(u'sponsor_campaign', 'visibility')

        # Deleting field 'Campaign.cssclass'
        db.delete_column(u'sponsor_campaign', 'cssclass')

        # Deleting field 'Campaign.style'
        db.delete_column(u'sponsor_campaign', 'style')

        # Deleting field 'Campaign.keyword'
        db.delete_column(u'sponsor_campaign', 'keyword')
