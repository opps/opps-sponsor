...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.published'
        db.add_column(u'sponsor_campaign', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.published'
        db.delete_column(u'sponsor_campaign', 'published')
