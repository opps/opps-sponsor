...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field mirror_site on 'Campaign'
        m2m_table_name = db.shorten_name(u'sponsor_campaign_mirror_site')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('campaign', models.ForeignKey(orm[u'sponsor.campaign'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['campaign_id', 'site_id'])


    def backwards(self, orm):
        # Removing M2M table for field mirror_site on 'Campaign'
        db.delete_table(db.shorten_name(u'sponsor_campaign_mirror_site'))
    ...
    models = {
        ...
        u'boxes.queryset': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['%s.%s']" % (User._meta.app_label, User._meta.module_name)})
        },
        u'channels.channel': {
        ...
        u'sponsor.campaign': {
            ...
            'mirror_site': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'sponsor_campaign_mirror_site'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['sites.Site']"}),
