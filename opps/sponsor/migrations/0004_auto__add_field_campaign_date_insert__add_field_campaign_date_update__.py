...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.date_insert'
        db.add_column(u'sponsor_campaign', 'date_insert',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 5, 3, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Campaign.date_update'
        db.add_column(u'sponsor_campaign', 'date_update',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 5, 3, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Campaign.user'
        db.add_column(u'sponsor_campaign', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounts.CustomUser']),
                      keep_default=False)

        # Adding field 'Campaign.site'
        db.add_column(u'sponsor_campaign', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'Campaign.date_available'
        db.add_column(u'sponsor_campaign', 'date_available',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.date_insert'
        db.delete_column(u'sponsor_campaign', 'date_insert')

        # Deleting field 'Campaign.date_update'
        db.delete_column(u'sponsor_campaign', 'date_update')

        # Deleting field 'Campaign.user'
        db.delete_column(u'sponsor_campaign', 'user_id')

        # Deleting field 'Campaign.site'
        db.delete_column(u'sponsor_campaign', 'site_id')

        # Deleting field 'Campaign.date_available'
        db.delete_column(u'sponsor_campaign', 'date_available')
    ...
    models = {
        ...
        u'sponsor.campaignpost': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['articles.Post']"})
        },
        u'sponsor.sponsor': {
